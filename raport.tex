...
Choć historia z~panda-ogrodnikiem jest celowo lekka, model BGT opisuje
...
\RM{}, \RF$(x)$ oraz wariant oracle są zaimplementowane bezpośrednio
...
\begin{itemize}[noitemsep]
  ...
  \item \texttt{oracle\_reduce\_max()}, \texttt{oracle\_reduce\_fastest()}
        oraz \texttt{oracle\_optimal()} – implementacje reguł wyboru cięcia;
...
\begin{enumerate}[noitemsep]
  \item \textbf{Sandbox} – użytkownik konfiguruje ogród (liczba bambusów,
        ...
        (z~regulowanym progiem $x$) i~optymalnego Oracle, obserwuje
...
\RM{}, \RF$(x)$ i~oracle nie są jedynie abstrakcyjne: dla tych samych
